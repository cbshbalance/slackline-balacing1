 ...
 *   기본값 = 예측점 A ≈ β + β̇/λ_u  (실험②의 w·λ_u 확정 후 아래 상수 교체!)
...
float LAMBDA_U = 6.4f;             // [1/s] ★실험② 실측값으로 교체
// 위험도 가중 (기본 = 예측점 β + β̇/λ). ★실험② w 확정 후 교체 (β성분=1 정규화)
float W0 = 0.0f, W1 = 1.0f, W2 = 0.0f, W3 = 1.0f / 6.4f;
